...
По умолчанию на серверах #05.1, #06, #07, #07.1 и #08 система кастомных спавнов активна.
...
* Когда [`!dlzsc`](commands.md#disable-large-zed-spawn-chance) стоит на `false`, подменяет случайный треш[^1] или медиумов[^2] бигами[^3] с соотношением 60:40 (60% на Мясников и 40% на Отбивальщиков);
